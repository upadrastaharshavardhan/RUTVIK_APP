    ...
    <div className="w-full">
      ...
      <section className="relative min-h-[100vh] md:h-screen flex items-center justify-center text-white py-20 md:py-0">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Welcome to RUTVIK</h1>
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto">Your trusted partner for spiritual services and astrological guidance</p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
            {/* Rutvik NRI Services Card */}
            <div className="bg-white/10 backdrop-blur-lg p-6 md:p-8 rounded-2xl border border-white/20 hover:bg-white/20 transition-all group">
              ...
              <h2 className="text-xl md:text-2xl font-bold mb-4">Rutvik NRI Services</h2>
              <p className="mb-6 text-white/80">Connect with your spiritual roots through online pooja services and ceremonies</p>
              <Link
                to="/book-pooja"
                className="inline-block bg-orange-600 text-white px-6 py-3 rounded-lg hover:bg-orange-700 transition-colors w-full md:w-auto"
              >
                Book Online Pooja
              </Link>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-lg p-6 md:p-8 rounded-2xl border border-white/20 hover:bg-white/20 transition-all group">
              ...
              <h2 className="text-xl md:text-2xl font-bold mb-4">RUTVIK Services</h2>
              <p className="mb-6 text-white/80">Connect with your spiritual roots through offline pooja services and ceremonies</p>
              <Link
                to="/rutvik-services"
                className="inline-block bg-purple-600 text-white px-6 py-3 rounded-lg hover:bg-purple-700 transition-colors w-full md:w-auto"
              >
                Book Offline Pooja
              </Link>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-lg p-6 md:p-8 rounded-2xl border border-white/20 hover:bg-white/20 transition-all group">
              ...
              <h2 className="text-xl md:text-2xl font-bold mb-4">Rutvik Muhurtham</h2>
              <p className="mb-6 text-white/80">Expert muhurtham consultancy and astrological guidance for life's important moments</p>
              <Link
            ...
            <div className="bg-white/10 backdrop-blur-lg p-6 md:p-8 rounded-2xl border border-white/20 hover:bg-white/20 transition-all group">
              ...
              <h2 className="text-xl md:text-2xl font-bold mb-4">Join RUTVIK</h2>
              <p className="mb-6 text-white/80">Connect with us & join with us to Perform pooja services and ceremonies</p>
              <Link
          ...
          <div className="mt-12">
            <button
              ...
              className="w-full md:w-auto bg-gradient-to-r from-orange-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-orange-700 hover:to-purple-700 transition-all flex items-center justify-center"
            >
              Get Started
